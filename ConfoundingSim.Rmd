...
write.csv(qmatrix, file = "ConfLinear.csv")
...
qmatrix = data.frame(qmatrix)
write.csv(qmatrix, file = "ConfNonLinearSquared.csv")
...
qmatrix = data.frame(qmatrix)
write.csv(qmatrix, file = "ConfNonLinearCubed.csv")
